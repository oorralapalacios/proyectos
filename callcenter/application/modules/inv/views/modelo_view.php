 ...
 <script type="text/javascript">
        var tema= "ui-redmond";
        var oper;
        var url = "<?php echo site_url("inv/modelos/ajax"); ?>";
...
<div class="main">
	<div class='titnavbg'>
      <div class='titnavtit'><img border='0'style="vertical-align: middle;" src="<?php echo base_url(); ?>assets/img/inv.png">&nbsp;&nbsp;Inventario: Modelos</div>
