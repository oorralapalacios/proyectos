 ...
 <script type="text/javascript" src="<?php echo base_url();?>assets/jqwidgets/jqxdropdownlist.js"></script>
    <script type="text/javascript">
        var tema= "ui-redmond";
        var oper;
        var url = "<?php echo site_url("inv/marcas/ajax"); ?>"; 
...
<div class='main'>
    <div class='titnavbg'>
	    <div class='titnavtit'><img border='0'style="vertical-align: middle;" src="<?php echo base_url(); ?>assets/img/inv.png">&nbsp;&nbsp;Inventario: Marcas</div>
