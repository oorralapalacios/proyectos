 ...
 <script type="text/javascript" src="<?php echo base_url();?>assets/jqwidgets/jqxexpander.js"></script>
   ...
   <script type="text/javascript">
    ...
    <div class="main">
    	<div class='titnavbg'>
	     <div class='titnavtit'><img border='0'style="vertical-align: middle;" src="<?php echo base_url(); ?>assets/img/inv.png">&nbsp;&nbsp;Reportes: Listado de citas por Teleoperadora</div>
			            	 ...
			            	 <div id="ventana" style='white-space: nowrap;'>
						                <script>
											function generaReporteCit(){
												...
												url= "<?php echo site_url("rep/cittels/generar_pdfTel"); ?>"+"/"+id_empleado+"/"+fecha_ini+"/"+fecha_fin+"/"+empleado; 
