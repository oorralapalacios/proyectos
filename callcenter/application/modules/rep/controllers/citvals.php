...
class Citvals extends MX_Controller
{
	...
	function index()
	{
		   ...
		   $this->load->view('rep/citval_view');
...
// datos por defecto de cabecera, se pueden modificar en el archivo tcpdf_config_alt.php de libraries/config
        $pdf->SetHeaderData('logo.jpg', PDF_HEADER_LOGO_WIDTH, 'REPORTE DETALLADO DE CITAS VALIDADAS ', 'DESDE: '.$fecha_ini.' HASTA: '.$fecha_fin, array(0, 64, 255), array(0, 64, 128));
