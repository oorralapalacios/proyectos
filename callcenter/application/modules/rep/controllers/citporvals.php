...
class Citporvals extends MX_Controller
{
	...
	function index()
	{
		   ...
		   $this->load->view('rep/citporval_view');
	...
	function generar_pdfCitVal($id_empleado,$fecha_ini,$fecha_fin,$empleado){
...
// datos por defecto de cabecera, se pueden modificar en el archivo tcpdf_config_alt.php de libraries/config
        $pdf->SetHeaderData('logo.jpg', PDF_HEADER_LOGO_WIDTH, 'REPORTE DETALLADO DE CITAS POR VALIDAR ', 'DESDE: '.$fecha_ini.' HASTA: '.$fecha_fin, array(0, 64, 255), array(0, 64, 128));
...
//fijar efecto de sombra en el texto
        ...
        $html .= "<tr>".$gestor."<th>Cedula</th><th>Nombres</th><th>Apellidos</th><th>Tel&eacute;fono</th>
					  <th>Direccion</th><th>Fecha-Hora Cita</th></tr>";
        $html .= "</thead>";
