<html>
    ...
    <script type="text/javascript">
       ...
       pivotGrid= function(fecha_ini,fecha_fin){
       	 ...
       	 var arr_cols=["respuesta","proceso"];
         var url= "<?php echo site_url("piv/estasig/ajax"); ?>"+"/"+fecha_ini+"/"+fecha_fin; 
		...
		disp_setting+="scrollbars=yes,width=650, height=600, left=100, top=25";
		  ...
		  //var content_vlue=source;
		   ...
		   html+='<head><title>Asignación y Reasignación</title>';
		   ...
		   html+='<h1>Asignación y Reasignación</h1>';
