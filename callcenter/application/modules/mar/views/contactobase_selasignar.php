 ...
 <script type="text/javascript">
      ...
      //codigo para inicializacion del formulario
        function createElementsSelAsignar() {
            ...
            $('#eventWindowSelAsignar').jqxWindow({
                resizable: false,
                width : '100%',
                height: '100%',
                theme: tema,
                ...
                initContent: function () {
                     ...
                     $('#btnSelProcesar').focus();
                     
                     $("#btnSelProcesar").click(function () {
                    	selasignar();
                     });
                     
                     $("#btnSelAsignarseguimiento").click(function () {
                    	sasignarseguimiento();
                     });
                }
            });
      ...
      function abrirSelAsignacion(){
      	 ...
      	 $('#btnSelProcesar').jqxButton({theme: tema, width: '65px' });	
      	 $('#btnSelAsignarseguimiento').jqxButton({theme: tema, width: '250px' });
      	 $('#eventWindowSelAsignar').jqxWindow('open');
	   ...
	   function selasignar(){
                    ...
                    AsigItems = [];	
                    AsigItems.length=0;
                    var getselectedrowindexes = $('#seljqxgrid').jqxGrid('getselectedrowindexes');
                         for (var i = 0; i < getselectedrowindexes.length; i++) {
                     	 var selectedRowData = $('#seljqxgrid').jqxGrid('getrowdata', getselectedrowindexes[i]);
                     	 var item={
		                        ...
		                        $.ajax({
		                            ...
		                            success: function (data) {
		                                ...
		                                if(data=true){
		                                    ...
		                                    $("#seljqxgrid").jqxGrid('updatebounddata');
		                                    $("#seljqxgrid").jqxGrid('clearselection');
...
<div style="visibility: hidden; display:none;" id="jqxWidgetSelAsignar">			
		<div style="display:none;" id="eventWindowSelAsignar">
                    ...
                    <form id="frmSelAsignar">
                    	...
                    	<table>
                    		...
                    		<tr>
                    			...
                    			<td><input style="margin-right: 5px;" type="button" id="btnSelProcesar" value="Asignar" /></td>
                   		 		<td><input style="margin-right: 5px;" type="button" id="btnSelAsignarseguimiento" value="Asignar seguimiento telefónico" /></td>
