   ...
   function gridDatos(adp,titulo){
        ...
        function intGridDatos(){
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Fecha hora', datafield: 'fecha_hora', width: '20%' },
        ...
        function opgestionar(){
			var selectedrowindex = $("#jqxgrid").jqxGrid('getselectedrowindex');
                	 ...
                	 if (selectedrowindex >= 0) {
	                        ...
	                        $("#vidcontactocampana").val(dataRecord.id);
	                        $("#vproceso").val('Validacion de citas');
							...
							valpreguntas_datos(dataRecord.campana_id,dataRecord.contacto_id,dataRecord.contacto_campana_id);
	                        }else{
		...
		function opreconsular(){
		 ...
		 function setTitulo(titulo){
    		...
    		if (titulo=='Citas confirmadas') {
    			
    			$('#jqxMenu').jqxMenu('disable', '61', true);
    		} else {
    			$('#jqxMenu').jqxMenu('disable', '61', false);
    		}
