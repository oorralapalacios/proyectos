	<script type="text/javascript">
        ...
        function createElements() {
            $('#eventWindow').jqxWindow({
                ...
                initContent: function () {
                     $('#btImportar').jqxButton({theme: tema, width: '100px' });
		...
		function ulistaCampanas(){
		 ...
		 function gridExportado(){
								...
								$("#drop").jqxGrid({theme: tema, width: '100%', height: "350px",  editable: true, filterable: true ,
								    //pageable: true,
								    //selectionmode: 'multiplecellsadvanced',
									 ...
									 columns: [
									     { text: '', datafield: 'Borrar', width: 60, columntype: 'button',id:'number', cellsrenderer: function () {
						                  ...
						                  { text: 'Nombre Cliente', datafield: 'nombre_cliente', width: 200, cellclassname: cellnombrecliente },
						                  //{ text: 'Nombre', datafield: 'nombres', width: 200, cellclassname: cellnombre },
						                  //{ text: 'Apellidos', datafield: 'apellidos', width: 200, cellclassname: cellapellido },
							              ...
							              { text: 'Telefono casa', datafield: 'telefono_casa_convencional', width: 150 },
							              { text: 'Telefono trabajo convencional', datafield: 'telefono_trabajo_convencional', width: 150 },
							              { text: 'Telefono trabajo movil', datafield: 'telefono_trabajo_movil', width: 150 },
							              { text: 'Email personal', datafield: 'email_personal', width: 200 },
							              { text: 'Email trabajo', datafield: 'email_trabajo', width: 200 },
							              { text: 'Aprobacion', datafield: 'aprobacion', width: 100 },
							              { text: 'Limite plan', datafield: 'limite_plan', width: 100 },
							              { text: 'Limite equipo', datafield: 'limite_equipo', width: 100 },
         ...
         function ValidaImportado(){
          ...
          for (var i = 0; i < rows.length; i++) {
             ...
             /*if (row.identificacion==undefined){
              ...
              valida=false;
             }else */if (row.nombre_cliente==undefined){
              valida=false;
             ...
             else if (!validaTelefonoMovil(row.telefono_movil)){
                valida=false;
             }
          } 
                     ...
                     <form id="fmpr">
                        <table>
                            <tr>
                                ...
                                <td align="left" colspan="2"><div id="empleado_id" name="empleado_id"></div></td>
                                <td align="right">Campa&ntilde;a:</td>
                                <td align="left" colspan="2"><div id="campana_id" name="campana_id"></div></td>
                            </tr>
						</table>
                     </form>
				            <style>
										...
										case "json":
											...
											var source = {
								               ...
								               datafields: [
								                   ...
								                   { name: 'telefono_casa_convencional', type: 'string' },
								                   { name: 'telefono_trabajo_convencional', type: 'string' },
								                   { name: 'telefono_trabajo_movil', type: 'string' },
								                   { name: 'email_personal', type: 'string' },
								                   { name: 'email_trabajo', type: 'string' },
