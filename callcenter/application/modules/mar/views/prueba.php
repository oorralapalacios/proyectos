        ...
        $(document).ready(function () {
            ...
            var initrowdetails = function (index, parentElement, gridElement, datarecord) {
                ...
                if (tabsdiv != null) {
                    ...
                    $(detalle).append(grid.jqxGrid({width : '100%',
		            height: '100%',
		            //theme: tema,
		            //source: adpcontactos(),
		            //groupable: true,
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                source: dataAdapter,
                rowdetails: true,
                rowdetailstemplate: { rowdetails: "<div style='margin: 10px;'><ul style='margin-left: 30px;'><li class='title'></li><li>Detalle</li></ul><div class='information'></div><div class='detalle'></div></div>", rowdetailsheight: 200 },
                /*ready: function () {
